...
Db.insert_ticket(db,'Printer Toner Low', 'Printer Toner at Location 241 is running low', 3, 1,'tester', 'Toner, Printer', assigned='sample.user')
Db.insert_ticket(db,'Server slow', 'Server has exceded IOPS warning threshold', 3, 1, 'tester', 'Server', assigned='sample.user')
Db.insert_ticket(db,'Risky Signin', 'The user "customer" logged in from an unknown location', 3, 1, 'tester', assigned='sample.user')
...
Db.insert_ticket(db,'Everything is broken! What is going on OMHG HLLPP!', 'this is a test1', 2, 1, 'tester', assigned='tester')
...
Db.update_ticket(db, id=1, priority=2, user_id='sample.user')
